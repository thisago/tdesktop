...
void Filler::addUserActions(not_null<UserData*> user) {
	...
	_addAction(QString("Go to first message"), GoToFirstMessageHandler(user), nullptr);
}
...
void Filler::addChatActions(not_null<ChatData*> chat) {
	...
	_addAction(QString("Go to first message"), GoToFirstMessageHandler(chat), nullptr);
}
...
void Filler::addChannelActions(not_null<ChannelData*> channel) {
	...
	_addAction(QString("Go to first message"), GoToFirstMessageHandler(channel), nullptr);
}
